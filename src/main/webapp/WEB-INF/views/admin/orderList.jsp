			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.Huangheng.model.Order o=(com.Huangheng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.Huangheng.dao.UserDao userDao=new com.Huangheng.dao.UserDao();
						...
						<%
							...
							String paymentType=com.Huangheng.model.Payment.findByPaymentId(con,n);
							 %>
